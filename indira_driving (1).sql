...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 12, 2023 at 07:25 AM
...
INSERT INTO `classes_dl` (`id`, `class_name`, `package_name`, `nfd`, `simulation`, `onroad`, `theory`, `reverse`, `testround`, `fees`) VALUES
...
CREATE TABLE `enrollment` (
  ...
  `llrdate` varchar(30) NOT NULL,
  `validity` varchar(30) NOT NULL,
  `classname` varchar(30) NOT NULL,
  `nfd` varchar(40) NOT NULL,
  `classdetails` varchar(80) NOT NULL,
...
(0, 'Angel Jansi', 'angel@123', 'angel', 'instructor', '9884631330', '2023-07-01', '25000', '2023-07-05', '200', '4000', '8 hours', '10000');
