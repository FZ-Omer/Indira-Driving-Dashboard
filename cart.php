...
<head>
    <meta charset="utf-8">
    <title>Guhan Agencies - Cart</title>
        ...
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    ...
                    <a class="text-body mr-3" href="">Safety Tips</a>
                </div>
            </div>
            <div class="col-lg-6 text-center text-lg-right">
                ...
                <div class="d-inline-flex align-items-center d-block d-lg-none">
                    ...
                    <a href="cart.php"><i class="fas fa-shopping-cart"></i> <span class="cart-item badge badge-danger"></span></a>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        <a href="" class="nav-item nav-link">Single Crackers</a>
        ...
        <div class="table-responsive mt-2">
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                <td colspan="3">
                  <a href="cart.php" class="btn btn-success"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Continue
                    Shopping</a>
                </td>
