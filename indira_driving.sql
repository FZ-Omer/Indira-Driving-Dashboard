...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2023 at 11:30 AM
...
INSERT INTO `enrollment` (`id`, `enquiry`, `student_name`, `father_name`, `dob`, `photo`, `address`, `referencer`, `phoneno`, `blood`, `point`, `enroll14`, `llr`, `validity`, `package`, `classname`, `nfd`, `fees`, `amount_paid`, `previous_paid`, `balance_amount`, `enr_id`, `existing_student`, `working`, `class_time`, `status`, `license_no`) VALUES
(1, 'Yes', 'Angel', 'Daniel', '1997-02-14', '', 'Chennai , Tamil nadu', 'Umar', '987867761', 'b+ve', '120', 'Completed', '18-07-2023', '18-07-2023', 'RC', 'Update Rc', '20', '3000', '', '', '', 'IND-EN001', 'client1', 'License', '', 'Payment', ''),
(3, 'Yes', 'umar', 'fazil', '2023-07-08', 'client-2.jpg', ' Seekar south street, Guindy', 'ashik', '987867761', 'b+ve', '120', 'Completed', '18-06-2023', '18-07-2023', 'RC', 'Update Rc', '20', '3000', '1000', '3000', '0.00', 'IND-EN002', '', 'License', '', 'Dispatched', 'LC-123456789'),
(4, 'No', 'Rashmika', 'Sekar', '1999-11-18', 'client-2.jpg', 'Tirunelveli main street, Tirunelveli', 'Hari', '987867761', 'b+ve', '120', 'Completed', 'LLR Date', 'LLR Validity Date', 'DL', 'Premium Package', '45', '8000', '', '', '', 'IND-EN003', '', '', '7:00 AM', 'Discount Rejected', '');
